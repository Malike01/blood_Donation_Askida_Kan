...
public class DonnorActivity extends AppCompatActivity {
    ...
    {
        Intent intent = new Intent(this, com.example.blood_donation_askida_kan.ProfileActivity.class);
        startActivity(intent);
    }
    @Override
    ...
    public void GoSearch(View view) {
        Intent intent = new Intent(this, com.example.blood_donation_askida_kan.SearchActivity.class);
        startActivity(intent);
    }
